...
namespace Ardunity
{
	...
	public class distinctionC : ArdunityReactor
    {
        ...
        void Update()
        {
            ...
            RotationReactorC _curRotation1 = GameObject.Find("movingPerson").GetComponent<RotationReactorC>(); // 1번
            RotationReactor2C _curRotation2 = GameObject.Find("movingPerson").GetComponent<RotationReactor2C>(); // 2번
            RotationReactor3C _curRotation3 = GameObject.Find("movingPerson").GetComponent<RotationReactor3C>(); // 3번
            RotationReactor4C _curRotation4 = GameObject.Find("movingPerson").GetComponent<RotationReactor4C>(); // 4번
